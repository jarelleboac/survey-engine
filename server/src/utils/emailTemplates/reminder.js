    ...
    Message: {
        Body: {
            Html: {
				...
				<head>
					<title> Reminder for the Percentage Project Survey </title>
					<!--[if !mso]><!-- -->
																	...
																	<table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
																		<tr>
																			<td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
																				<div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;"> Hello!</div>
																			</td>
																		</tr>
																		<tr>
																			<td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
																				...
																				We're reaching out to remind you of your  unique survey link for The Percentage Project.
																				</div>
																			</td>
																		</tr>
																		<tr>
																		...
																		<tr>
																			<td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
																				<div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;"> 
																					If you have any questions or concerns, check out our FAQ or reach out to us at <a href="mailto:info@percentageproject.com">info@percentageproject.com</a>. 
																				</div>
																			</td>
																		</tr>
																		<tr>
